...
//
//  def getStage(backend: BackendProperties, name: Option[String]): Option[Stage] = {
//    for {
//      n <- name
...
//  }
//
//  def getStageFromSuccess(backend: BackendProperties, stage: Stage, success: Success): Stage = {
//    switch (success) {
...
//  }
//
//  def backendEquals(a: BackendProperties, b: BackendProperties): Boolean = {
...
//  }
//
//  def backendEquals(one: Option[BackendProperties], other: Option[BackendProperties]): Option[Boolean] = {
//    for {
//      a <- one
//      b <- other
...
//  }
//
//  def useViperServer(backend: BackendProperties) {
...
//  }
//
//  def expandCustomArguments(args: String, stage: Stage, fileToVerify: String, backend: BackendProperties): String = {
...
//  }
//
//  def selectBackend(settings: ViperSettings, selectedBackend: String): BackendProperties = {
...
//    }
//
//    def getBackend(backendName: String): BackendProperties = {
...
//    }
//
//    private def checkBackends(backends: BackendProperties[]) {
...
//    }
//
//    def backendJars(backend: BackendProperties): String = {
